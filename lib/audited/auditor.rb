  ...
  module Auditor #:nodoc:
    ...
    module ClassMethods
      ...
      def audited(options = {})
        ...
        has_many :audits, -> { where(service_name: Rails.application.class.parent_name).order(version: :asc) }, as: :auditable, class_name: Audited.audit_class.name, inverse_of: :auditable
